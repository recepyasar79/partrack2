...
export function Button({ 
  ...
  const variants = {
    ...
    outline: 'border-2 border-brand-500 text-brand-600 hover:bg-brand-50 focus:ring-brand-500 bg-transparent dark:text-brand-300 dark:border-brand-400 dark:hover:bg-brand-900/30',
