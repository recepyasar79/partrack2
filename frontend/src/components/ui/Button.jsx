...
export function Button({ 
  ...
  const variants = {
    ...
    secondaryDark: 'bg-slate-800 text-white hover:bg-slate-700 focus:ring-slate-500',
    ...
    outline: 'border-2 border-brand-500 text-brand-600 hover:bg-brand-50 focus:ring-brand-500 bg-transparent',
    ghost: 'bg-transparent text-slate-600 hover:bg-slate-100 focus:ring-slate-300',
    soft: 'bg-brand-50 text-brand-700 hover:bg-brand-100 focus:ring-brand-500',
  };
