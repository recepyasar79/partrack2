// Heroicons - Outline style SVG icons
...
export const ClipboardDocumentIcon = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const LoadingSpinner = ({ className = 'w-6 h-6' }) => (
  <svg className={`animate-spin ${className}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    <path className="opacity-75" fill="currentColor" d="M4.12 4.221a.75.75 0 0 1 1.18 0l8.466 8.47a.75.75 0 0 1 0 1.06l-8.466 8.47a.75.75 0 0 1-1.18 0l-8.47-8.466a.75.75 0 0 1 0-1.06l8.47-8.47Z"></path>
  </svg>
);

// Navigation icons with labels for mobile nav
export const navIcons = {
  daireler: BuildingIcon,
  araclar: CarIcon,
  'misafir-araclar': BadgeIcon,
  kontrol: CameraIcon,
  raporlar: ChartIcon,
};